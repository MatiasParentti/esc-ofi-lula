                ...
                <div className="container">
                    ...
                    <div className="row g-10 mt-5">
                        <div className="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <p className="mb-4 p-j">
                                Capacitación mediante el IMDEL: Esta modalidad se llevó a cabo durante dos años en coordinación con el centro de capacitación del IMDEL del Municipio de Moreno donde se capacitó en diferentes niveles de panadería y repostería.
