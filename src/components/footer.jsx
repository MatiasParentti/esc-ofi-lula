            ...
            <div className="container-fluid  text-light footer pt-5 mt-5 wow fadeIn" data-wow-delay="0.1s">
                <div className="container py-5">
                    <div className="col-lg-3 col-md-6">
                        ...
                        <p className="mb-2"><i className="fa fa-map-marker-alt me-3"></i>123 algun lado</p>
                        ...
                        <div className="d-flex pt-2">
                            ...
                            <a className="btn btn-outline-light btn-social" href="https://www.facebook.com/Escuela-de-Oficios-In%C3%A1cio-Lula-da-Silva-104201234553498/?ref=page_internal"><i className="fab fa-facebook-f"></i></a>
